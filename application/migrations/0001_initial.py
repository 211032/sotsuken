# Generated by Django 5.1.2 on 2024-12-10 07:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom_name', models.ForeignKey(default='01', on_delete=django.db.models.deletion.CASCADE, to='application.classroom')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('password', models.CharField(max_length=128)),
                ('class_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.studentclass')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            name='Timetable',
            fields=[
                ('timetable_id', models.AutoField(default=1, primary_key=True, serialize=False)),
